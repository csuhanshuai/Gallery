    ...
    public boolean drawBitmap(Canvas canvas, Bitmap backgroundBitmap,
        ...
        if (cropBitmap != null && !mHasDrawCropBitmap
            ...
            RectF mIconRectBounds = new RectF(
                    ...
                    backgroundBitmap.getHeight() / 2 + cropBitmap.getHeight()
                            / 2);
            int outBounder = (int) Math.max(mIconRectBounds.width(),
                    mIconRectBounds.height());
            RectF backgroundF = new RectF(mScreenBounds.left - outBounder,
                    mScreenBounds.top - outBounder, mScreenBounds.right
                            + outBounder, mScreenBounds.bottom + outBounder);
