...
static jboolean initRefocusNoDepthMap(JNIEnv *env, jobject thiz, jstring targetFilePath,
    ...
    initResult = mImageRefocus->initRefocusNoDepthMap(pTargetFilePath, outImgWidth, outImgHeight,
            ...
            pMaskBuffer, maskBufferSize, maskWidth, maskHeight);
...
static jboolean generateRefocusImage(JNIEnv *env, jobject thiz, jbyteArray resultBuffer, jint touchX,
        jint touchY, jint depthOfField) {
    ...
    generateResult = mImageRefocus->generateRefocusImage((unsigned char*)tempData, touchX, touchY,
            depthOfField);
...
static JNINativeMethod methods[] = {
  ...
  {"nativeInitRefocusNoDepthMapUseJpgBuf", "([BIIII[BIII[BIII)Z", (void*)initRefocusNoDepthMapUseJpgBuf},
